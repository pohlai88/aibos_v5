          ...
          <div className="bg-white shadow rounded-lg p-6 space-y-6">
            <div>
              ...
              <p className="text-sm text-gray-600 mb-6">
                Use these buttons to set up your database with sample data for testing the employee management system.
              </p>
            </div>
            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-md">
              <h4 className="text-sm font-medium text-gray-900 mb-2">What this creates:</h4>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• 8 sample departments (Engineering, Marketing, Sales, etc.)</li>
                <li>• 5 sample employees with different user types and statuses</li>
