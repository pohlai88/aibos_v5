  ...
  const fetchEmployee = async () => {
    try {
      ...
      setFormData({
        ...
        primary_email: employeeData.primary_email || "",
        recovery_email: employeeData.recovery_email || "",
        has_recovery_email: employeeData.has_recovery_email || false,
        user_type: employeeData.user_type || "candidate",
